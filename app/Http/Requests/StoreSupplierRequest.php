...
class StoreSupplierRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'document' => ['required', $this->id == 0 ? 
                        Rule::unique('suppliers')->where('document_type', $this->document_type) : 
                        Rule::unique('suppliers')->ignore($this->id)->where('document_type', $this->document_type)],
    ...
    public function messages()
    {
        return [
            ...
            'name.max' => 'Longitud máxima de 60 caracteres para el Nombre del Proveedor',
            'name.min' => 'Longitud minima  de 5 caracteres para el Nombre del Proveedor',
