...
{{--
      ...
      {{-- <li class="nav-item {{ ($activePage == 'profile' || $activePage == 'user-management') ? ' active' : '' }}">
        <a class="nav-link" data-toggle="collapse" href="#acceso" aria-expanded="true">
          <i><img style="width:25px"> </i>
          <p>{{ __('Acceso al Sistema') }}
            <b class="caret"></b>
          </p>
        </a>
        <div class="collapse show" id="acceso">
          <ul class="nav">
            <li class="nav-item{{ $activePage == 'profile' ? ' active' : '' }}">
              <a class="nav-link" href="">
                <span class="sidebar-mini">LI</span>
                <span class="sidebar-normal">{{ __('Ingresar') }} </span>
              </a>
            </li>
