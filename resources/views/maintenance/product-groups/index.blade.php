        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table-sm table-hover table-striped" id="groups" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('maintenance.productgroups.destroy',$group->id)}}"  method="post"
                                ...
                                @csrf
                                @method('delete')
                                <button class="btn-sm btn-danger"  data-bs-toggle="tooltip" title="Eliminar Grupo de Producto">
