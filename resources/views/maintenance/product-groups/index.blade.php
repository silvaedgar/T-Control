                                ...
                                <tbody>
                                    @foreach ($productgroups as $group)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('maintenance.productgroups.edit', $group) }}"
                                                    class="btnedit">
                                                ...
                                                <form
                                                    action="{{ route('maintenance.productgroups.destroy', $group->id) }}"
                                                    method="post" class="d-inline delete-item">
                                                    @csrf
                                                    @method('delete')
                                                    {{-- <input type="text" id="message-item-delete" value = "al Grupo de Producto: {{ $group->description}}"> --}}
                                                    <button class="btn-danger" data-bs-toggle="tooltip"
                                                        title="Eliminar Grupo de Producto">
